...
<body>
    <section id="main-content">
        ...
        <tbody>
            ...
            <td><a href="ubah_petugas.php?nisn=<?=$data_petugas['id_petugas']?>"
                    class="btn btn-success">Ubah</a> | 
                    <a href="hapus_data_petugas.php?id_petugas=<?=$data_siswa['id_petugas']?>"
    ...
    <script scr="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4"
